...
async def seed_data():
    ...
    async with Session() as session:
        try:
            ...
            professores = [
                Professor(
                    name="ARTHUR RODRIGUES ARARUNA", email="ararunaufc@gmail.com"
                ),
            ...
            professores_faltantes = [
                ...
                Professor(
                    name="ALEXANDRE MATOS ARRUDA", email="alexandre.matos@ufc.br"
                ),
                Professor(
                    name="WAGNER GUIMARAES AL ALAM", email="wagner.alalam@ufc.br"
                ),
            ]
            ...
            professor_por_email = {
                professor.email: professor for professor in professores
            }
            ...
            alunos = [
                Student(
                    registration=HashService.generate_hash(
                        matricula, HashAlgorithm.SHA256
                    )
                )
