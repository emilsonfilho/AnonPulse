...
async def seed_data():
    try:
        ...
        alunos = [
            Student(
                registration=HashService.generate_hash(m, HashAlgorithm.SHA256)
            )
        ...
        enrollments = [
                Enrollment(student=alunos_ordenados[0], classroom=turma_por_cod["FUP-RC-08A"]),
                Enrollment(student=alunos_ordenados[1], classroom=turma_por_cod["FUP-RC-08A"]),
                Enrollment(student=alunos_ordenados[2], classroom=turma_por_cod["FUP-RC-08A"]),
                Enrollment(student=alunos_ordenados[3], classroom=turma_por_cod["FUP-RC-08A"]),
                Enrollment(student=alunos_ordenados[4], classroom=turma_por_cod["FUP-RC-08A"]),
                Enrollment(student=alunos_ordenados[5], classroom=turma_por_cod["FUP-RC-09A"]),
                Enrollment(student=alunos_ordenados[6], classroom=turma_por_cod["FUP-RC-09A"]),
                Enrollment(student=alunos_ordenados[7], classroom=turma_por_cod["FUP-RC-09A"]),
                Enrollment(student=alunos_ordenados[8], classroom=turma_por_cod["FUP-RC-09A"]),
                Enrollment(student=alunos_ordenados[9], classroom=turma_por_cod["FUP-RC-09A"]),
                Enrollment(student=alunos_ordenados[10], classroom=turma_por_cod["FUP-SI-04A"]),
                Enrollment(student=alunos_ordenados[11], classroom=turma_por_cod["FUP-SI-04A"]),
                Enrollment(student=alunos_ordenados[12], classroom=turma_por_cod["FUP-SI-04A"]),
                Enrollment(student=alunos_ordenados[13], classroom=turma_por_cod["FUP-SI-04A"]),
                Enrollment(student=alunos_ordenados[14], classroom=turma_por_cod["FUP-SI-04A"]),
                Enrollment(student=alunos_ordenados[15], classroom=turma_por_cod["FUP-SI-05A"]),
                Enrollment(student=alunos_ordenados[16], classroom=turma_por_cod["FUP-SI-05A"]),
                Enrollment(student=alunos_ordenados[17], classroom=turma_por_cod["FUP-SI-05A"]),
                Enrollment(student=alunos_ordenados[18], classroom=turma_por_cod["FUP-SI-05A"]),
                Enrollment(student=alunos_ordenados[19], classroom=turma_por_cod["FUP-SI-05A"]),
                Enrollment(student=alunos_ordenados[20], classroom=turma_por_cod["FUP-CC-01A"]),
                Enrollment(student=alunos_ordenados[21], classroom=turma_por_cod["FUP-CC-01A"]),
                Enrollment(student=alunos_ordenados[22], classroom=turma_por_cod["FUP-CC-01A"]),
                Enrollment(student=alunos_ordenados[23], classroom=turma_por_cod["FUP-CC-01A"]),
                Enrollment(student=alunos_ordenados[24], classroom=turma_por_cod["FUP-CC-01A"]),
                Enrollment(student=alunos_ordenados[25], classroom=turma_por_cod["FUP-CC-02A"]),
                Enrollment(student=alunos_ordenados[26], classroom=turma_por_cod["FUP-CC-02A"]),
                Enrollment(student=alunos_ordenados[27], classroom=turma_por_cod["FUP-CC-02A"]),
                Enrollment(student=alunos_ordenados[28], classroom=turma_por_cod["FUP-CC-02A"]),
                Enrollment(student=alunos_ordenados[29], classroom=turma_por_cod["FUP-CC-02A"]),
                Enrollment(student=alunos_ordenados[30], classroom=turma_por_cod["FUP-IA-03A"]),
                Enrollment(student=alunos_ordenados[31], classroom=turma_por_cod["FUP-IA-03A"]),
                Enrollment(student=alunos_ordenados[32], classroom=turma_por_cod["FUP-IA-03A"]),
                Enrollment(student=alunos_ordenados[33], classroom=turma_por_cod["FUP-IA-03A"]),
                Enrollment(student=alunos_ordenados[34], classroom=turma_por_cod["FUP-IA-03A"]),
                Enrollment(student=alunos_ordenados[35], classroom=turma_por_cod["FUP-IA-10A"]),
                Enrollment(student=alunos_ordenados[36], classroom=turma_por_cod["FUP-IA-10A"]),
                Enrollment(student=alunos_ordenados[37], classroom=turma_por_cod["FUP-IA-10A"]),
                Enrollment(student=alunos_ordenados[38], classroom=turma_por_cod["FUP-IA-10A"]),
                Enrollment(student=alunos_ordenados[39], classroom=turma_por_cod["FUP-IA-10A"]),
                Enrollment(student=alunos_ordenados[40], classroom=turma_por_cod["FUP-EC-11A"]),
                Enrollment(student=alunos_ordenados[41], classroom=turma_por_cod["FUP-EC-11A"]),
                Enrollment(student=alunos_ordenados[42], classroom=turma_por_cod["FUP-EC-11A"]),
                Enrollment(student=alunos_ordenados[43], classroom=turma_por_cod["FUP-EC-11A"]),
                Enrollment(student=alunos_ordenados[44], classroom=turma_por_cod["FUP-EC-11A"]),
                Enrollment(student=alunos_ordenados[45], classroom=turma_por_cod["FUP-EC-12A"]),
                Enrollment(student=alunos_ordenados[46], classroom=turma_por_cod["FUP-EC-12A"]),
                Enrollment(student=alunos_ordenados[47], classroom=turma_por_cod["FUP-EC-12A"]),
                Enrollment(student=alunos_ordenados[48], classroom=turma_por_cod["FUP-EC-12A"]),
                Enrollment(student=alunos_ordenados[49], classroom=turma_por_cod["FUP-EC-12A"]),
                Enrollment(student=alunos_ordenados[50], classroom=turma_por_cod["FUP-ES-06A"]),
                Enrollment(student=alunos_ordenados[51], classroom=turma_por_cod["FUP-ES-06A"]),
                Enrollment(student=alunos_ordenados[52], classroom=turma_por_cod["FUP-ES-06A"]),
                Enrollment(student=alunos_ordenados[53], classroom=turma_por_cod["FUP-ES-06A"]),
                Enrollment(student=alunos_ordenados[54], classroom=turma_por_cod["FUP-ES-06A"]),
                Enrollment(student=alunos_ordenados[55], classroom=turma_por_cod["FUP-ES-07A"]),
                Enrollment(student=alunos_ordenados[56], classroom=turma_por_cod["FUP-ES-07A"]),
                Enrollment(student=alunos_ordenados[57], classroom=turma_por_cod["FUP-ES-07A"]),
                Enrollment(student=alunos_ordenados[58], classroom=turma_por_cod["FUP-ES-07A"]),
                Enrollment(student=alunos_ordenados[59], classroom=turma_por_cod["FUP-ES-07A"]),
                Enrollment(student=alunos_ordenados[60], classroom=turma_por_cod["FUP-DD-01A"]),
                Enrollment(student=alunos_ordenados[61], classroom=turma_por_cod["FUP-DD-01A"]),
                Enrollment(student=alunos_ordenados[62], classroom=turma_por_cod["FUP-DD-01A"]),
                Enrollment(student=alunos_ordenados[63], classroom=turma_por_cod["FUP-DD-01A"]),
                Enrollment(student=alunos_ordenados[64], classroom=turma_por_cod["FUP-DD-01A"]),
                Enrollment(student=alunos_ordenados[65], classroom=turma_por_cod["FUP-DD-02A"]),
                Enrollment(student=alunos_ordenados[66], classroom=turma_por_cod["FUP-DD-02A"]),
                Enrollment(student=alunos_ordenados[67], classroom=turma_por_cod["FUP-DD-02A"]),
                Enrollment(student=alunos_ordenados[68], classroom=turma_por_cod["FUP-DD-02A"]),
                Enrollment(student=alunos_ordenados[69], classroom=turma_por_cod["FUP-DD-02A"]),
                Enrollment(student=alunos_ordenados[70], classroom=turma_por_cod["POO-01A"]),
                Enrollment(student=alunos_ordenados[71], classroom=turma_por_cod["POO-01A"]),
                Enrollment(student=alunos_ordenados[72], classroom=turma_por_cod["POO-01A"]),
                Enrollment(student=alunos_ordenados[73], classroom=turma_por_cod["POO-01A"]),
                Enrollment(student=alunos_ordenados[74], classroom=turma_por_cod["POO-01A"]),
                Enrollment(student=alunos_ordenados[75], classroom=turma_por_cod["POO-02A"]),
                Enrollment(student=alunos_ordenados[76], classroom=turma_por_cod["POO-02A"]),
                Enrollment(student=alunos_ordenados[77], classroom=turma_por_cod["POO-02A"]),
                Enrollment(student=alunos_ordenados[78], classroom=turma_por_cod["POO-02A"]),
                Enrollment(student=alunos_ordenados[79], classroom=turma_por_cod["POO-02A"]),
                Enrollment(student=alunos_ordenados[80], classroom=turma_por_cod["ED-SI-01A"]),
                Enrollment(student=alunos_ordenados[81], classroom=turma_por_cod["ED-SI-01A"]),
                Enrollment(student=alunos_ordenados[82], classroom=turma_por_cod["ED-SI-01A"]),
                Enrollment(student=alunos_ordenados[83], classroom=turma_por_cod["ED-SI-01A"]),
                Enrollment(student=alunos_ordenados[84], classroom=turma_por_cod["ED-SI-01A"]),
                Enrollment(student=alunos_ordenados[85], classroom=turma_por_cod["ED-SI-04A"]),
                Enrollment(student=alunos_ordenados[86], classroom=turma_por_cod["ED-SI-04A"]),
                Enrollment(student=alunos_ordenados[87], classroom=turma_por_cod["ED-SI-04A"]),
                Enrollment(student=alunos_ordenados[88], classroom=turma_por_cod["ED-SI-04A"]),
                Enrollment(student=alunos_ordenados[89], classroom=turma_por_cod["ED-SI-04A"]),
                Enrollment(student=alunos_ordenados[90], classroom=turma_por_cod["ED-ES-02A"]),
                Enrollment(student=alunos_ordenados[91], classroom=turma_por_cod["ED-ES-02A"]),
                Enrollment(student=alunos_ordenados[92], classroom=turma_por_cod["ED-ES-02A"]),
                Enrollment(student=alunos_ordenados[93], classroom=turma_por_cod["ED-ES-02A"]),
                Enrollment(student=alunos_ordenados[94], classroom=turma_por_cod["ED-ES-02A"]),
                Enrollment(student=alunos_ordenados[95], classroom=turma_por_cod["ED-ES-05A"]),
                Enrollment(student=alunos_ordenados[96], classroom=turma_por_cod["ED-ES-05A"]),
                Enrollment(student=alunos_ordenados[97], classroom=turma_por_cod["ED-ES-05A"]),
                Enrollment(student=alunos_ordenados[98], classroom=turma_por_cod["ED-ES-05A"]),
                Enrollment(student=alunos_ordenados[99], classroom=turma_por_cod["ED-ES-05A"]),
            ]
